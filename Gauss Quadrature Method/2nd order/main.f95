program main
    ...
    real , dimension(:,:), allocatable :: optimizer ! these are those points where we do weighted sum
    integer :: i , j, degree

    print *, "Enter the order of the polynomial  (Hint : 2 to 5):: "
    read *, degree
    print *, "Enter the upper limit of x axis :: " ! getting the limits for the integration 
    read *, upper_x
    ...
    if (degree == 2) then  ! here we define the weights and points for the integration
    ...
    do i = 1,degree       ! This loops do the integration using Gauss Quadrature formula
        do j = 1,degree
    ...
    contains
        real function func(m,t)  ! function for defining the function make them in limit 1 to -1
            real , intent(in) :: t , m
            real :: output , x ,y
