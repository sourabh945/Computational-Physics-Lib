program main 
   ...
   integer :: num_of_intervals , j , last_point , energy_num_steps , k , l  
   double precision :: x_upper,x_lower , h , energy  , normalizer , pot_energy , a
   double precision :: max_si , energy_upper , energy_lower , energy_step_size  
   logical :: f1 , peak = .false. 
   
   print*, "Enter the value of the energy : " 
   read*, energy_upper 
   print*, "Enter the lower limit of the energy :: "
   read*, energy_lower 
   print*, "Enter the number of steps for energy :: "
   read*, energy_num_steps
   ...
   energy_step_size = (energy_upper - energy_lower)/real(energy_num_steps)
 do k = 1,energy_num_steps
   energy = energy_lower + k*energy_step_size
   peak = .false.
   ...
   enddo
   deallocate(x,si,si1,potential_energy)
   write(1,*)""
enddo    	
